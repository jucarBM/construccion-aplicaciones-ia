"""Aplicación completa de lab-03, ejecutable de forma independiente."""


from fastapi import Depends, FastAPI, HTTPException

from .chat import conversar
from .configuracion import cliente_demo, exigir_api_key
...
app = FastAPI(title="Tienda IA · lab-03", version="1.0.0")
